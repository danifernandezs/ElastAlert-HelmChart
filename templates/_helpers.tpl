...
Common labels
*/}}
{{- define "elastalert.labels" -}}
helm.sh/chart: {{ include "elastalert.chart" . }}
{{ include "elastalert.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "elastalert.selectorLabels" -}}
